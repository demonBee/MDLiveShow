...
- (void)configInputContainerView {
    ...
    [_emojiButton setImage:[UIImage imageNamed:@"chatting_biaoqing_btn_normal"] forState:UIControlStateNormal];
//    [_emojiButton setImage:RCDLive_IMAGE_BY_NAMED(@"chatting_biaoqing_btn_normal") forState:UIControlStateNormal];

    [_emojiButton setImage:[UIImage imageNamed:@"chatting_biaoqing_btn_selected"] forState:UIControlStateSelected];
