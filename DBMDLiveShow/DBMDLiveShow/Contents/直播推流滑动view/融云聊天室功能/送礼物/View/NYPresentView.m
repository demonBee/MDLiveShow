...
//    self.headImageView.image = giftModel.headImage;
    [self.headImageView sd_setImageWithURL:[NSURL URLWithString:giftModel.headImageStr] placeholderImage:[UIImage imageNamed:@"placeholderPhoto"] completed:^(UIImage *image, NSError *error, SDImageCacheType cacheType, NSURL *imageURL) {
